 ...
 */
final class Version20220612214732 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE color ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE month ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME DEFAULT NULL');
